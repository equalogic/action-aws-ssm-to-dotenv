import { __require as requireMain } from '../../../@fastify/busboy/lib/main.js';
...
function requireBody () {
	...
	const { DOMException, structuredClone } = requireConstants();
	const { Blob, File: NativeFile } = require$$7;
	const { kBodyUsed } = requireSymbols$1();
	const assert = require$$0;
	const { isErrored } = requireUtil();
...
export { requireBody as __require };
